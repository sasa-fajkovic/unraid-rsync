...
if (!function_exists('ur_option_help')) {
    ...
    function ur_option_help(): array
    {
        return [
            ...
            'mkpath'         => 'Create the destination path, including any missing parent directories, before transferring (--mkpath). On by default so backing up to a brand-new target does not fail with a missing-directory error.',
            // --- destructive flags -----------------------------------------
